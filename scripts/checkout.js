...
function getDeliveryOptionElements(index, productId) {
  ...
  // delivery option text
    deliveryOptionDate = document.createElement("span");
...
function renderItemsInCartSummary() {
  ...
  for (const cartItem of cart) {
    ...
    const product = productList.find(_product => _product.id === productId);
    if (!product) {
    ...
    // PROBLEM: zistit aky input ma property value on, a z toho inputu najst najblizsi span s class 
    //deliveryOptionDate a priradit innerHTML  hodnotu do deliveryDat.innerHTML
    console.log('toto je deliveryoptiondate', deliveryOptionDate);
    deliveryDate.innerHTML = "Delivery date: " + deliveryOptionDate;
